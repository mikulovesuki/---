...
根据 Blonk 近期关于剩余食物拯救的研究，该数值为$2.7 kg CO2e/kg$。
\subsubsection{非食品类避免排放因子（取 $3.0\ kg\ \mathrm{CO}_2e/kg$）的合理性}

取各商品平均值
\subsubsection{冷藏仓储$0.05\ kg\ \mathrm{CO}_2e/month$与运输排放因子的合理性$0.2\ kg\ \mathrm{CO}_2e/km$}

\subsubsection{消费者自提交通排放因子的合理性$238.6 \ g\ \mathrm{CO}_2e/km$}
