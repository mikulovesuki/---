...
\subsubsection{食品类避免排放因子（取 $2.7\ \mathrm{kg\ CO}_2e/\mathrm{kg}$）的合理性}
...
\subsubsection{非食品类避免排放因子（取 $3.0\ \mathrm{kg\ CO}_2e/\mathrm{kg}$）的合理性}
...
\subsubsection{冷藏仓储（取 $0.05\ \mathrm{kg\ CO}_2e/\mathrm{month}$）与运输排放因子（取 $0.2\ \mathrm{kg\ CO}_2e/\mathrm{km}$）的合理性}
...
\subsubsection{消费者自提交通排放因子（取 $238.6\ \mathrm{g\ CO}_2e/\mathrm{km}$）的合理性}
