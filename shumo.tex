...
\begin{abstract}
本项目以避免因商品浪费而产生的排放与最大化净碳减排量为主要目标，将折扣零售过程中引入的任何额外排放纳入考虑，建立了基于生命周期评估（LCA）理论的碳排放核算模型，量化了初创公司通过深度折扣销售临期商品所实现的年度净$\mathrm{CO}_{2e}$减排量。模型综合考虑了避免浪费带来的碳排放减少与折扣零售运营引入的额外碳排放，采用控制变量法对关键参数进行敏感性分析，识别出主要影响因素。基于核算结果，设计了一套积分奖励机制，进一步激励消费者参与该环保商业模式，实现更大范围的资源高效利用和碳减排。

本研究通过系统性的生命周期评估方法，建立了一套科学、可操作的碳排放核算体系。该体系不仅量化了临期商品折扣销售模式的环保价值，更为初创公司的可持续发展战略提供了数据支撑。在此基础上，本研究进一步引入阶梯消费激励机制，将减排效果与消费者权益挂钩，形成“环保行为——碳减排量——消费奖励”的完整闭环，既激励消费者主动参与，又放大了商业模式的社会与环境双重效益。研究的出发点和落脚点均指向同一个目标：在市场机制与环境伦理的有机结合中，探索可持续零售模式的商业可行性与环保可持续性。

综合上述三项任务的实现路径，本研究构建了一套完整的碳减排核算与激励体系。研究发现，通过深度折扣和延长商品消费周期等销售策略，该公司基准情景下年度净减排可达$145.3$吨$\mathrm{CO}_{2e}$，相当于植树2400余棵的年均固碳量，具有显著的环保效益；敏感性分析表明，避免排放因子和废弃物转移率是影响减排效益的主导因素，其波动范围为$\pm 25\%$时净减排量变化幅度约$\pm 20\%$，模型表现出良好的稳定性。进一步引入基于消费者行为的阶梯积分奖励机制，根据单次消费的碳减排贡献设计等级化激励，既能精准量化微观消费行为的环保价值，又能通过积分兑换权益形成消费正反馈，预期可扩大销售规模$15\%-30\%$，进而放大年度净减排效果。本研究为临期商品流转中的碳减排提供了量化评估框架，为新型可持续零售模式的商业化推广奠定了科学基础，具有重要的实践应用价值和政策参考意义。

\vspace{1em}
\noindent \textbf{关键词：} 生命周期评估（LCA）；碳排放核算；临期商品；折扣零售；敏感性分析；积分奖励机制；可持续发展
\end{abstract}
...
>>>>>>> 736cb496d3d4aa75ca20419f20e810893308c000
\section*{附录}
